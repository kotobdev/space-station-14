...
public sealed partial class CosmicGlyphComponent : Component
{
    ...
    [DataField] public SoundSpecifier TriggerSFX = new SoundPathSpecifier("/Audio/CosmicCult/glyph_trigger.ogg");
    [DataField] public SoundSpecifier ChargeSFX = new SoundPathSpecifier("/Audio/CosmicCult/glyph_charge.ogg");
    [DataField] public SoundSpecifier FailSFX = new SoundPathSpecifier("/Audio/CosmicCult/glyph_fail.ogg");
