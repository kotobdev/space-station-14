...
public sealed partial class CosmicCultComponent : Component
{
    ...
    [DataField] public SoundSpecifier BlankSFX = new SoundPathSpecifier("/Audio/CosmicCult/ability_blank.ogg");
    [DataField] public SoundSpecifier IngressSFX = new SoundPathSpecifier("/Audio/CosmicCult/ability_ingress.ogg");
    [DataField] public SoundSpecifier GlareSFX = new SoundPathSpecifier("/Audio/CosmicCult/ability_glare.ogg");
    [DataField] public SoundSpecifier NovaCastSFX = new SoundPathSpecifier("/Audio/CosmicCult/ability_nova_cast.ogg");
    [DataField] public SoundSpecifier ImpositionSFX = new SoundPathSpecifier("/Audio/CosmicCult/ability_imposition.ogg");
    #endregion
}
